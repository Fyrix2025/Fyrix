...
const SingleBrand = ({ brand }: { brand: Brand }) => {
  ...
  return (
    <div className="flex w-1/2 items-center justify-center px-3 py-[15px] sm:w-1/2 md:w-1/3 lg:w-1/4 xl:w-1/6">
      ...
      >
        <Image
          src={imageLight || "/fallback-image-light.png"} // Provide a fallback image
          alt={name || "Brand"} // Provide a fallback alt text
          fill
          className="hidden dark:block"
        />
        <Image
          src={image || "/fallback-image.png"} // Provide a fallback image
          alt={name || "Brand"} // Provide a fallback alt text
          fill
