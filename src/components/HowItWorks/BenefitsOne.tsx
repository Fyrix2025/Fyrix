...
const BenefitsOne: Feature[] = [
  {
    ...
    title: "Quick Results",
    paragraph:
      "We understand the importance of meeting deadlines and delivering results quickly & that's why we work efficiently and effectively to deliver your projects faster than you expect, without sacrificing quality or attention to detail.",
  },
  {
    id: 2,
    icon: (
    ...
    title: "Secure Assurance",
    paragraph:
      "We prioritize the safety and reliability of your website. With cutting-edge security measures and rigorous testing procedures, you can trust that your website will be secure and reliable at all times.",
  },
  {
    id: 3,
    icon: (
    ...
    paragraph:
      "We take pride in our unwavering commitment to customer satisfaction. With years of experience, unmatched dedication, and a track record of success, our customers trust us to deliver exceptional results time and time again.",
  },
];
